  ...
  return (
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='relative mb-[-2rem] bottom-[2.3rem] left-[60%] w-[40%]'>  
                <div className='flex flex-row justify-end bg-transparent space-x-4'>
                    <div className="">
                        <input {...register("bowler" , {required: "enter a name"})} type="text" id="bowler" name="bowler" placeholder='bowler' className="bg-transparent border border-content text-content text-sm rounded-lg focus:ring-content focus:border-secondary block w-80 p-2.5 "/>
                    </div>
                    <div className="">
                        <input {...register("batter" , {required: "enter a name"})} type="text" id="batter" name="batter" placeholder='batter' className="bg-transparent border border-content text-content text-sm rounded-lg focus:ring-content focus:border-secondary block w-80 p-2.5 "/>
                    </div>
